...
struct OtherUserCitiesGridView: View {
    @Bindable var vm: OtherUserTravelHistoryViewModel
    ...
    private var overlayContentSection: some View {
        Group {
            if vm.isLoading {
                ...
                Text("This user hasn't reviewed any cities yet.")
            }
        }
    }
}
